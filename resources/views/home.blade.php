...
<head>
    ...
    <title>Shopee</title>
    <link rel="icon" href="{{('public/frontend/img/logo/shopee-logo.png')}}" type="image/x-icon">
            ...
            <nav class="header__navbar hide-on-mobile-tablet">
                <ul class="header__nav-list">
                    ...
                    <div class="header__qrcode">
                        <img src="{{('public/frontend/img/qr/qr-code.png')}}" class="header__qr">
                        ...
                        <div id="list-product" class="row sm-gutter">
                            <div class="col l-2-4 m-3 c-6 home-product-item">
                                <a class="home-product-item-link" href="#">
                                    <div class="home-product-item__img" style="background-image: url(public/frontend/img/home/1.PNG);"></div>
                            ...
                            <div class="col l-2-4 m-3 c-6 home-product-item">
                                <a class="home-product-item-link" href="#">
                                    <div class="home-product-item__img" style="background-image: url(public/frontend/img/home/2.PNG);"></div>
                                    <div class="home-product-item__info">
                                        <h4 class="home-product-item__name">Ổ đĩa flash USB2.0 2TB Hp kim loại chống thấm nước</h4>
                                        <div class="home-product-item__price">
...
<!-- script js -->
<script src="{{('public/frontend/js/product.js')}}"></script>
</body>
</html>
